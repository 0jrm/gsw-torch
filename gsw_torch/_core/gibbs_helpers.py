...
def gibbs_000_zerop(SA, pt):
    ...
    g03 = 101.342743139674 + y * (
        ...
        * (
            ...
            * (
                ...
                * (
                    -148.185936433658
                    + y * (58.0259125842571 + y * (-18.9843846514172 + y * 3.05081646487967))
                )
            )
        )
    )
    ...
    g08 = x2 * (
        ...
        * (
            ...
            * (
                -493.407510141682
                + y * (-43.0664675978042 + y * (-10.0227370861875 + y * 0.875600661808945))
            )
        )
        + y
        * (
...
def gibbs_010_zerop(SA, pt):
    ...
    log_term = torch.where(SA > 0.0, 851.226734946706 * x2 * torch.log(x), torch.zeros_like(x2))
    g08 = g08 + log_term
